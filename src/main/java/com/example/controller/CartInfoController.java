...
//        System.out.println(userId+level+goodsId);
    ...
    //电影页面展示时
    @GetMapping("/findIsLike")
    public Result findIsLike(@RequestParam Long userId,@RequestParam Long goodsId,@RequestParam Integer level){
//        System.out.println("userId："+userId);
//        System.out.println("goodsId"+goodsId);
        CartInfo cartInfo = cartInfoService.findIsLike(userId, goodsId,level);
